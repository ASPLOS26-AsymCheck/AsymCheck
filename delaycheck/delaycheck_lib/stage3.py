...
class DeepSpeedZeroOptimizer_Stage3(ZeROOptimizer):
    ...
    def __init__(
        ...
        # resnet152 
        # self.reduce_bucket_size = 8000000 # 7524101
        
        # vit-large
        # self.reduce_bucket_size = 80000000 # 75845908
        
        # gpt-large 
        # self.reduce_bucket_size = 200000000 # 193507520
        
        # bert-large
        self.reduce_bucket_size = 90000000 # 83525122
    ...
    # Zero-3 Gradient Allreduc operation
    ...
    def __reduce_and_partition_ipg_grads(self, safe_mode: bool = False) -> None:
        ...
        with get_accelerator().stream(self.reduce_and_partition_stream):
            ...
            # Partition gradients and offload to local CPU memory or disk 
            # 
