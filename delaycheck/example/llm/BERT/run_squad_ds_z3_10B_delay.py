    ...
    for epoch in range(0, int(args.num_train_epochs) + 1):
        ...
        for idx, batch_data in enumerate(train_iter):             
            ...
            if idx == 40 and dist.get_rank() % 2 == 0 :
                ...
                # optimizer.optimizer_queue.put((cpu_optimizer_array_1, cpu_optimizer_array_1, cpu_optimizer_array_2, cpu_optimizer_array_2))
...
if __name__ == '__main__':
    ...
    model, optimizer, _, _ = delay_lib.initialize(
        args=args,
        model=model,
