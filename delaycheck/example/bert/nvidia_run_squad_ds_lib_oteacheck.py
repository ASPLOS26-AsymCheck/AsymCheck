    ...
    if args.do_train:
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch in enumerate(train_dataloader):
                ...
                if dist.get_rank() % torch.cuda.device_count() == 0 and step % args.ckpt_freq == 0 and numel_count != 0:
                    model_state = optimizer.shard_buffer[:numel_count]
                    oteacheck_lib.utils.save_checkpoint_async_model(model, model_state, num_epoch, step)

                if step != 0 and step % args.load_freq == 0 and numel_count != 0:
                ...
                if (step + 1) % (
                    ...
                    # # Backward Time and Allreduce Time
